...
namespace Tygh\UpgradeCenter\Connectors\CategoriesExim;
...
class Connector implements UCInterface
{
    ...
    public function __construct()
    {
        ...
        // Initial settings
        $addon_scheme = SchemesManager::getScheme('categories_exim');
        $this->settings = array(
            'upgrade_server' => 'http://cs.pervolo.com/index.php',
            'addon_id' => $addon_scheme->getId(),
            'license_number' => Registry::get('addons.categories_exim.license_key'),
