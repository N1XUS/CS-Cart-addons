...
{if $category_data.description || $runtime.customization_mode.live_editor}
    <div id="category_description_{$category_data.category_id}">
    ...
    <!--category_description_{$category_data.category_id}--></div>
{/if}
...
{capture name="mainbox_title"}<span {live_edit name="category:category:{$category_data.category_id}"} id="category_name_{$category_data.category_id}">{$category_data.category}<!--category_name_{$category_data.category_id}--></span>{/capture}
{/hook}
