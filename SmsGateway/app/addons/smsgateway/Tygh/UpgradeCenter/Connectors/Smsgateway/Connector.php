...
namespace Tygh\UpgradeCenter\Connectors\Smsgateway;
...
class Connector implements UCInterface
{
    ...
    public function __construct()
    {
        ...
        // Initial settings
        $addon_scheme = SchemesManager::getScheme('smsgateway');
        $this->settings = array(
            'upgrade_server' => 'http://cs.pervolo.com/index.php',
            'addon_id' => $addon_scheme->getId(),
            'license_number' => Registry::get('addons.smsgateway.license_key'),
