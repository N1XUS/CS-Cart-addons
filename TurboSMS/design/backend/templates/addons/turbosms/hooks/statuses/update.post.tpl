<div class="control-group">
    <label for="custom_sms_message_{$id}" class="control-label">{__("addons.turbosms.custom_sms_message")}:</label>
    <div class="controls cm-no-hide-input" id="container_custom_sms_message_{$id}">
        ...
        <span class="help-block">{__("addons.turbosms.sms_placeholders")}</span>
