...
namespace Tygh\UpgradeCenter\Connectors\AdvancedPromotions;
...
class Connector implements UCInterface
{
    ...
    public function __construct()
    {
        ...
        // Initial settings
        $addon_scheme = SchemesManager::getScheme('advanced_promotions');
        $this->settings = array(
            'upgrade_server' => 'http://cs.pervolo.com/index.php',
            'addon_id' => $addon_scheme->getId(),
            'license_number' => Registry::get('addons.advanced_promotions.license_key'),
