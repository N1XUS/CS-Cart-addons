...
namespace Tygh\UpgradeCenter\Connectors\FeaturesAsOptions;
...
class Connector implements UCInterface
{
    ...
    public function __construct()
    {
        ...
        // Initial settings
        $addon_scheme = SchemesManager::getScheme('features_as_options');
        $this->settings = array(
            'upgrade_server' => 'http://cs.pervolo.com/index.php',
            'addon_id' => $addon_scheme->getId(),
            'license_number' => Registry::get('addons.features_as_options.license_key'),
