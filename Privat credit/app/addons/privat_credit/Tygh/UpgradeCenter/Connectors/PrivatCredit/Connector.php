...
namespace Tygh\UpgradeCenter\Connectors\PrivatCredit;
...
class Connector implements UCInterface
{
    ...
    public function __construct()
    {
        ...
        // Initial settings
        $addon_scheme = SchemesManager::getScheme('privat_credit');
        $this->settings = array(
            'upgrade_server' => 'http://cs.pervolo.com/index.php',
            'addon_id' => $addon_scheme->getId(),
            'license_number' => Registry::get('addons.privat_credit.license_key'),
